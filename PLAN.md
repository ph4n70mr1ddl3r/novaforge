...
- Traceability is the definition of done: the committed coverage matrix maps every one of the 728 requirements to app metadata or a visible gap; `BuildrightAppArtifactTests` gates the artifact, the suites, and the matrix's honesty

 ...
 * publishEvent, branch, iterate}; grammar-fixed (compile-checked, activation in a later
 * phase): {@code requestApproval, transitionState} (Phase 4), {@code callConnector}
 * (Phase 6). Additions are versioned platform features, never per-app code.</p>
 */
...
public record FlowStep(
    ...
    public static final java.util.Set<String> DEFERRED_OPS = java.util.Set.of(
            "requestApproval", "transitionState", "callConnector");

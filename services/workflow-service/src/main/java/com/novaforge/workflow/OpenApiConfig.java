...
public class OpenApiConfig {
    ...
    OpenAPI serviceOpenApi() {
        return new OpenAPI().info(new Info()
                .title("NovaForge Workflow Service")
                .description("The human-task plane: inbox APIs, approvals with durable flow suspension and SoD, SLAs with escalation, and embedded Flowable BPMN execution.")
                .version("0.1.0"));
    }
}

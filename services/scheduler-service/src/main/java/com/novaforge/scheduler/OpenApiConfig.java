...
public class OpenApiConfig {
    ...
    OpenAPI serviceOpenApi() {
        return new OpenAPI().info(new Info()
                .title("NovaForge Scheduler Service")
                .description("The cron registry: publish-driven job definitions, leased single-fire execution, run history, and the read-only builder status route.")
                .version("0.1.0"));
    }
}

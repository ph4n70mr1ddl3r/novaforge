...
Verified: `BuildrightWorkflowRegisterTests` + `BuildrightAppArtifactTests` green (metadata-service, 14 tests); generator idempotent against the canons; no e2e-module or product Java touched (the register is test-side plus generated artifacts).
